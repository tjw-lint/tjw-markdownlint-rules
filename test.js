...
let expectedResults = [
  ...
  './test-files/md014.md: 3: MD014/commands-show-output Dollar signs used before commands without showing output [Context: "$ ls"]',
  ...
  './test-files/md022.md: 2: MD022/blanks-around-headings/blanks-around-headers Headings should be surrounded by blank lines [Expected: 2; Actual: 0; Above] [Context: "## lines_above: 2, lines_below: 1"]',
